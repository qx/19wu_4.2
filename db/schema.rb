...
ActiveRecord::Schema.define(version: 20150516142649) do
  ...
  create_table "event_order_fulfillments", force: :cascade do |t|
    t.integer  "order_id"
  ...
  create_table "event_order_items", force: :cascade do |t|
  ...
  create_table "event_order_participants", force: :cascade do |t|
    t.integer  "order_id",               null: false
  ...
  create_table "event_order_refunds", force: :cascade do |t|
    t.integer  "order_id",                   null: false
  ...
  create_table "event_order_shipping_addresses", force: :cascade do |t|
    t.integer  "order_id",                 null: false
  ...
  create_table "event_order_status_transitions", force: :cascade do |t|
  ...
  create_table "fallback_urls", force: :cascade do |t|
    t.string   "origin"
    t.string   "change_to"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "group_collaborators", force: :cascade do |t|
    t.integer  "group_id"
    t.integer  "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "group_topic_replies", force: :cascade do |t|
    t.text     "body"
